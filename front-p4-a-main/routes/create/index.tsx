...
export const handler: Handlers = {
  async POST(req: Request, ctx: FreshContext) {//Cambie el req y el ctx
    ...
    try {
      await axios.post(`${API_BASE_URL}/api/posts`, {//He puesto todas las variables en ingles title, cover etc y arriba tambien
        title,
        content,
        author,
        cover,
