      ...
      <header className="header">
        <div className="container">
          ...
          <nav className="nav">
            ...
            <a href="/search" className="nav-link" /*hay que cambiar el href*/>Buscar</a>
            <a href="/create" className="nav-link" /*Hay que cambiar el href*/>Crear</a>
          </nav>
        </div>
      </header>
        ...
        <div className="container">
          <div className="footer-content">
            ...
            <div className="footer-section">
              ...
              <ul>
                <li /*Aqui tambien hay que cambiar las href */>
                  <a href="/">Inicio</a>
                </li>
                <li>
